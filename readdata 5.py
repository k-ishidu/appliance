                        ...
                        for blist in blist_list:
                            for bvariation in blist:
                                if bvariation[1]>newbvariation[1]:
                                    ...
                                    breakflag=1
                                    break
                                if blist_list[blist_list.index(blist)+1][0][1]>newbvariation[1]:
...
def plot_wave(node,maxindex,teacherdata_list,bigteacherdata_list):
    ...
    while len(newevent_list)>0:
        ...
        if len(plotevent_list)!=0:
            ...
            evaluation=customknn(teacherdata_list,bigteacherdata_list,evaluate_list,start,5)
...
if __name__ == '__main__':
    ...
    #homenumber='0030'
    date='2019-01-17-'
    nextdate='2019-01-18-'    #teacherdata=make_teacherdata()
    ...
    print("以下推定結果")
    make_eventtree(make_smasockpowerlist(date,nextdate,0,4000),teacherdata[0],teacherdata[1],teacherdata[2],0)